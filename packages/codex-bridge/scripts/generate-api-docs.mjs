...
const schemaRoot = resolve(packageRoot, "src/generated-schema")
...
const responseMapSource = await readFile(resolve(packageRoot, "src/response-map.ts"), "utf8")
