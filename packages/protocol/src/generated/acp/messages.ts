...
export const AGENT_ACP_V2_CLIENT_RPC = {
  ...
  "session/prompt": { request: "agent.acp.session.prompt.request", response: "agent.acp.session.prompt.response", requestSchema: acpRequestSchema(2, "agent.acp.session.prompt.request", acpV2Zod.zPromptRequest), responseSchema: acpResponseSchema(2, "agent.acp.session.prompt.response", acpV2Zod.zPromptResponse, true) },
