...
describe("Cypheria protocol", () => {
  ...
  it("dispatches every logical session wire type from a flat discriminator", () => {
    ...
    expect((SessionInboundMessageSchema as z.ZodDiscriminatedUnion).options).toHaveLength(129)
    expect((SessionOutboundMessageSchema as z.ZodDiscriminatedUnion).options).toHaveLength(146)
  })
