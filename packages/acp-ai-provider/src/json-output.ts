...
type JsonTextStartPart = Extract<LanguageModelV4StreamPart, { type: "text-start" }>
 ...
 */
export function buildJsonSchemaPrompt(responseFormat: JsonResponseFormat): string {
  const parts: string[] = []
