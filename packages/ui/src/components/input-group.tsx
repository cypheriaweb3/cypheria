...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: Preserve the upstream div API and ARIA semantics without introducing fieldset form behavior.
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: Clicking the addon only focuses the input, which is already keyboard reachable.
    // biome-ignore lint/a11y/useSemanticElements: Preserve the upstream div API and ARIA semantics without introducing fieldset form behavior.
    <div
      role="group"
